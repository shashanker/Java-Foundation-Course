              ...
              <div class="row">
                <div class="col-lg-8">
                  <div class="intro-body">
                    <p class="intro-title-top">${property.address2 }</p>
                    <h1 class="intro-title mb-4">
                      <span class="color-b">${property.address1 }</h1>
                    <p class="intro-subtitle intro-price">
                      <a href="#"><span class="price-a">${property.type } | $ ${property.price }</span></a>
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="title-wrap d-flex justify-content-between">
            ...
            <s:url var="property_url" value="/allprops"/>
              <a href="${ property_url}">All Property
                <span class="ion-ios-arrow-forward"></span>
              </a>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="title-wrap d-flex justify-content-between">
            ...
            <div class="title-link">
            <s:url value="/allAgents" var="allAgents"></s:url>
              <a href="${ allAgents}">All Agents
                <span class="ion-ios-arrow-forward"></span>
              </a>
            </div>
          </div>
