  ...
  <section class="property-grid grid">
    <div class="container">
      <div class="row">
        ...
        <s:url var="property_single" value="/property-single"/>
        <c:forEach items="${properties}" var="property">
        <div class="col-md-4">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="resources/img/${property.imgUrl }" alt="" class="img-a img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                  <h2 class="card-title-a">
                    <a href="#">${property.address2}</a>
                  </h2>
                </div>
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">${property.type } | $ ${property.price }</span>
                  </div>
                  <a href="${property_single }/${property.id}" class="link-a">Click here to view
