      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">${property.address1 }</h1>
            <span class="color-text-a">${property.address2 }</span>
          </div>
        </div>
        ...
        --> <div class="col-md-12">
          ...
          <div class="row">
            <div class="col-md-6 col-lg-4">
              <img src="/resources/img/${property.agent.pic }" alt="" class="img-fluid">
            </div>
            <div class="col-md-6 col-lg-4">
              <div class="property-agent">
                ...
                <ul class="list-unstyled">
                  ...
                  <li class="d-flex justify-content-between">
                    <strong>Skype:</strong>
                    <span class="color-text-a">${property.agent.skype }</span>
                  </li>
                </ul>
                <div class="socials-a">
