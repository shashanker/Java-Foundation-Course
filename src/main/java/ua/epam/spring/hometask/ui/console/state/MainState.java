...
public class MainState extends AbstractState {
    ...
    public MainState(ApplicationContext context) {
    	...
    	childStates.put(1, context.getBean(AuditoriumManageState.class));
        childStates.put(2, context.getBean(EventManageState.class));
        childStates.put(3, context.getBean(UserManageState.class));
        childStates.put(4, context.getBean(BookingState.class));
